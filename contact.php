    ...
    <header class="site-header js-site-header">
      <div class="container-fluid">
        <div class="row align-items-center">
          <div class="col-6 col-lg-4 site-logo" data-aos="fade"><a href="index.html">Bahria Residence</a></div>
            ...
            <form action="contact.php" method="post" class="bg-white p-md-5 p-4 mb-5 border">
              <div class="row">
                ...
                <div class="col-md-6 form-group">
                  ...
                  <input type="text" id="phone" name="phone" class="form-control " require>
                </div>
              </div>
              ...
              <div class="row mb-4">
                <div class="col-md-12 form-group">
                  ...
                  <textarea name="message" id="message" class="form-control " cols="30" rows="8" require></textarea>
                </div>
              </div>
              <div class="row">
                <div class="col-md-6 form-group">
      ...
      <div class="container">
        <div class="row mb-4">
          ...
          <div class="col-md-3 mb-5 pr-md-5 contact-info">
            ...
            <p><span class="d-block"><span class="ion-ios-location h5 mr-3 text-primary"></span>Address:</span> <span> 198 3543 Street, <br> Suite 721 New York NY 10016</span></p>
            <p><span class="d-block"><span class="ion-ios-telephone h5 mr-3 text-primary"></span>Phone:</span> <span> 465445</span></p>
