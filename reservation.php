...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
   ...
   $sql = "INSERT INTO reservations (name, phone, email, checkin_date, checkout_date, adults, children, message) 
        VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
$stmt = $conn->prepare($sql);
$stmt->bind_param("sssssiis", $name, $phone, $email, $checkin_date, $checkout_date, $adults, $children, $message);
...
<html>
  ...
  <form action="reservation.php" method="post" class="bg-white p-md-5 p-4 mb-5 border">
    <div class="row">
  ...
  <div class="row">
    ...
    <!-- Add these scripts to the bottom of your HTML body -->
<script src="js/jquery-3.3.1.min.js"></script>
<script src="js/bootstrap.min.js"></script>
<script src="js/bootstrap-datepicker.js"></script>
<script src="js/main.js"></script>
...
<script>
  ...
  $(document).ready(function() {
    $('#checkin_date').datepicker({
      format: 'yyyy-mm-dd', // Set the format to match MySQL date format
      autoclose: true
    });
